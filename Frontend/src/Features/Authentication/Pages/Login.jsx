...
export default function Login() {
    ...
    const { login } = useAuth()
    const [form, setForm] = useState({ email: 'harsh02@gmail.com', password: 'HarshPassword#1' })
