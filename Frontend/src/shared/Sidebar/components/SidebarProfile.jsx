...
export default function SidebarProfile() {
  ...
  return (
    <div className="mt-auto pt-4 relative" ref={profileDropdownRef}>
      <div
      ...
      {showProfile && (
        <div
          className="absolute bottom-full left-2 right-2 mb-2 rounded-2xl p-2 z-50 transition-all duration-300"
          style={{
